...
#
# Source0 file verified with key 0x791890532CB5CDDE (users@clusterlabs.org)
#
Name     : libqb
Version  : 2.0.2
Release  : 5
URL      : https://github.com/ClusterLabs/libqb/releases/download/v2.0.2/libqb-2.0.2.tar.xz
Source0  : https://github.com/ClusterLabs/libqb/releases/download/v2.0.2/libqb-2.0.2.tar.xz
Source1  : https://github.com/ClusterLabs/libqb/releases/download/v2.0.2/libqb-2.0.2.tar.xz.asc
Summary  : libqb
...
%prep
%setup -q -n libqb-2.0.2
cd %{_builddir}/libqb-2.0.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1607058442
...
cp %{_builddir}/libqb-2.0.2/COPYING %{buildroot}/usr/share/package-licenses/libqb/9a647436aa2324c4cb849c6f3d31c392ed50d9bd
%make_install

...
Version  : 2.0.3
Release  : 6
URL      : https://github.com/ClusterLabs/libqb/releases/download/v2.0.3/libqb-2.0.3.tar.xz
Source0  : https://github.com/ClusterLabs/libqb/releases/download/v2.0.3/libqb-2.0.3.tar.xz
Source1  : https://github.com/ClusterLabs/libqb/releases/download/v2.0.3/libqb-2.0.3.tar.xz.asc
Summary  : libqb
...
%prep
%setup -q -n libqb-2.0.3
cd %{_builddir}/libqb-2.0.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1628613287
...
cp %{_builddir}/libqb-2.0.3/COPYING %{buildroot}/usr/share/package-licenses/libqb/9a647436aa2324c4cb849c6f3d31c392ed50d9bd
%make_install
